...
/***/ function(module, exports, __webpack_require__) {
	...
	// APP COMPONENT
	function App(props) {
	  return React.createElement(CheckerBoard, { rows: props.rowNumbers });
	}
	...
	function CheckerBoard(props) {
	  ...
	  for (var i = 0; i < props.rows; i += 1) {
	    ...
	    checkeredRows.push(React.createElement(Row, { key: i, rowNum: i, cells: props.rows }));
	  }
	...
	function Row(props) {
	  ...
	  for (var i = 0; i < props.cells; i += 1) {
	    checkeredCells.push(React.createElement(Cell, { key: i, color: i % 2 === 0 ? colorA : colorB, style: styles.cell }));
	  }
	  return React.createElement(
	    'div',
	    { style: styles.row },
	...
	ReactDOM.render(React.createElement(App, { rowNumbers: prompt("How many rows should the checkerboard have?") }), document.getElementById('app'));
